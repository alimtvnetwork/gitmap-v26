...
```
User specifies:    E:\gitmap-v25           (or /opt/gitmap-v25)
Tool ensures:      GITMAP_HOME=E:\gitmap-v25   is set persistently
                   E:\gitmap-v25 is in PATH    if not already present
```
...
```
$ <tool> env home E:\gitmap-v25
```

This does:

1. Validates the directory exists (or creates it with confirmation)
2. Sets `<TOOL>_HOME=E:\gitmap-v25` persistently
3. Adds `E:\gitmap-v25` to PATH if not already present
...
$ <tool> env home E:\gitmap-v25
  ...
  To activate in this session:
    ...
    $env:GITMAP_HOME = "E:\gitmap-v25"
    $env:Path = "E:\gitmap-v25;" + $env:Path
...
export GITMAP_HOME="/opt/gitmap-v25"   # <tool>-env
```
...
$ <tool> env doctor
  ...
  [OK]   GITMAP_HOME = E:\gitmap-v25 (directory exists)
  [OK]   E:\gitmap-v25 is in PATH
...
$ <tool> env doctor
  ...
  [FAIL] GITMAP_HOME = E:\gitmap-v25 (directory does NOT exist)
  [WARN] E:\gitmap-v25 is NOT in PATH

  Suggested fix:

    <tool> env home E:\gitmap-v25    # Re-register with valid path
