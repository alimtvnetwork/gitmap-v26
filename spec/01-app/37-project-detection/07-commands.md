...
|----------------------|-------|------------------------------------|
| `gitmap-v25 go-repos`    | `gr`  | List repos containing Go projects  |
| `gitmap-v25 node-repos`  | `nr`  | List repos containing Node projects|
| `gitmap-v25 react-repos` | `rr`  | List repos containing React projects|
| `gitmap-v25 cpp-repos`   | `cr`  | List repos containing C++ projects |
| `gitmap-v25 csharp-repos`| `sr`  | List repos containing C# projects  |
...
not exist, print: `"No database found. Run 'gitmap-v25 scan' first."`
