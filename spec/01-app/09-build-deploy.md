...
```powershell
$ldflags = "-X 'github.com/alimtvnetwork/gitmap-v22/gitmap/constants.RepoPath=$absRepoRoot'"
...
```
  ...
  ──────────────────────────────────────────────────
  → Runner CWD: D:\wp-work\riseup-asia\gitmap-v22
  → Repo root: D:\wp-work\riseup-asia\gitmap-v22
...
| Repo root | Root of the gitmap-v22 project |
