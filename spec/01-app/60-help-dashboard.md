...
The `help-dashboard` command (alias `hd`) serves the gitmap-v24 documentation
...
```
gitmap-v24 help-dashboard [flags]
gitmap-v24 hd [flags]
```
...
The command locates the docs site relative to the gitmap-v24 binary:
...
1. `gitmap-v24 help-dashboard` serves `dist/` when it exists and opens
   the browser automatically.
2. `gitmap-v24 hd` works as an alias.
...
7. `gitmap-v24 help-dashboard --help` prints the embedded help text.
