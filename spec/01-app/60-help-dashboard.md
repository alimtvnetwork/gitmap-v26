...
The `help-dashboard` command (alias `hd`) serves the gitmap-v25 documentation
...
```
gitmap-v25 help-dashboard [flags]
gitmap-v25 hd [flags]
```
...
The command locates the docs site relative to the gitmap-v25 binary:
...
1. `gitmap-v25 help-dashboard` serves `dist/` when it exists and opens
   the browser automatically.
2. `gitmap-v25 hd` works as an alias.
...
7. `gitmap-v25 help-dashboard --help` prints the embedded help text.
