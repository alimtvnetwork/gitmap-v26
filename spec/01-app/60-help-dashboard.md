...
The `help-dashboard` command (alias `hd`) serves the gitmap-v22 documentation
...
```
gitmap-v22 help-dashboard [flags]
gitmap-v22 hd [flags]
```
...
The command locates the docs site relative to the gitmap-v22 binary:
...
1. `gitmap-v22 help-dashboard` serves `dist/` when it exists and opens
   the browser automatically.
2. `gitmap-v22 hd` works as an alias.
...
7. `gitmap-v22 help-dashboard --help` prints the embedded help text.
