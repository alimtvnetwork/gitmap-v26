...
```go
// Root directory — all repo-local gitmap-v22 data lives here.
...
Projects using gitmap-v22 should add `.gitmap/output/` to their `.gitignore`.
...
When any gitmap-v22 command runs and detects a legacy directory in the current
