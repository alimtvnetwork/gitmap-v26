...
```go
// Root directory — all repo-local gitmap-v25 data lives here.
...
Projects using gitmap-v25 should add `.gitmap/output/` to their `.gitignore`.
...
When any gitmap-v25 command runs and detects a legacy directory in the current
