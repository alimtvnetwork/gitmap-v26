...
```go
// Root directory — all repo-local gitmap-v24 data lives here.
...
Projects using gitmap-v24 should add `.gitmap/output/` to their `.gitignore`.
...
When any gitmap-v24 command runs and detects a legacy directory in the current
