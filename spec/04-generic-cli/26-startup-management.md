...
| User-scope by default; `--system` opt-in for machine-wide | Matches `gitmap-v25 self-install` philosophy — no admin required for the common case |
...
```
gitmap-v25 startup add      <name> <command> [--method <m>] [--scope user|system] [--delay <duration>]
gitmap-v25 startup add      --interactive
gitmap-v25 startup list     [--json]
gitmap-v25 startup remove   <name> [--method <m>]
gitmap-v25 startup enable   <name>
gitmap-v25 startup disable  <name>
gitmap-v25 startup env-add  <KEY=VALUE> [--scope user|system]
gitmap-v25 startup env-list [--json]
gitmap-v25 startup env-rm   <KEY>      [--scope user|system]
```

### Flat aliases

```
gitmap-v25 startup-add        ⇄ gitmap-v25 startup add
gitmap-v25 startup-add-i      ⇄ gitmap-v25 startup add --interactive
gitmap-v25 startup-list       ⇄ gitmap-v25 startup list
gitmap-v25 startup-remove     ⇄ gitmap-v25 startup remove
gitmap-v25 startup-enable     ⇄ gitmap-v25 startup enable
gitmap-v25 startup-disable    ⇄ gitmap-v25 startup disable
gitmap-v25 env-add            ⇄ gitmap-v25 startup env-add
gitmap-v25 env-list           ⇄ gitmap-v25 startup env-list
gitmap-v25 env-rm             ⇄ gitmap-v25 startup env-rm
```
...
When `--interactive` is passed, `gitmap-v25 startup add` prompts the user
...
`gitmap-v25 startup list` can report a unified view without scraping
each backend.
...
Constants live in `gitmap-v25/constants/constants_startup.go` and are
...
- `spec/04-generic-cli/22-self-update-gold-standard.md` — `gitmap-v25 self-install` precedent for OS-specific install logic
