...
```
User runs: gitmap-v25 scan --verbose
  │
...
✓ Deploy path       OK — E:\bin-run\gitmap-v25\
```
...
|----------|--------|---------|
| User (stderr) | Plain, actionable | `"Error: config.json not found. Run 'gitmap-v25 doctor' to diagnose."` |
