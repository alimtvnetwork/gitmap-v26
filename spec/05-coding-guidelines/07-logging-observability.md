...
```
User runs: gitmap-v22 scan --verbose
  │
...
✓ Deploy path       OK — E:\bin-run\gitmap-v22\
```
...
|----------|--------|---------|
| User (stderr) | Plain, actionable | `"Error: config.json not found. Run 'gitmap-v22 doctor' to diagnose."` |
