...
```
User runs: gitmap-v24 scan --verbose
  │
...
✓ Deploy path       OK — E:\bin-run\gitmap-v24\
```
...
|----------|--------|---------|
| User (stderr) | Plain, actionable | `"Error: config.json not found. Run 'gitmap-v24 doctor' to diagnose."` |
