...
After installing gitmap-v24 via `curl | sh` on macOS (zsh default), the binary
...
3. gitmap-v24 works in zsh terminals.
4. User opens `sh` or switches to bash → `gitmap-v24: command not found`.
