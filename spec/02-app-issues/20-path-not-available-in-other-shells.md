...
After installing gitmap-v25 via `curl | sh` on macOS (zsh default), the binary
...
3. gitmap-v25 works in zsh terminals.
4. User opens `sh` or switches to bash → `gitmap-v25: command not found`.
