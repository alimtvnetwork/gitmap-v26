...
cmd/installvscode.go:11:2: "github.com/alimtvnetwork/gitmap-v24/gitmap-v24/constants" imported and not used
```
...
`installvscode.go` imported `github.com/alimtvnetwork/gitmap-v24/gitmap-v24/constants` but never
...
1. Before adding a helper function to a new file, search the `cmd` package
   ...
   `grep -rn "^func <name>" gitmap-v24/cmd/`
