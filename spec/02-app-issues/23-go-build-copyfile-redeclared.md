...
cmd/installvscode.go:11:2: "github.com/alimtvnetwork/gitmap-v25/gitmap-v25/constants" imported and not used
```
...
`installvscode.go` imported `github.com/alimtvnetwork/gitmap-v25/gitmap-v25/constants` but never
...
1. Before adding a helper function to a new file, search the `cmd` package
   ...
   `grep -rn "^func <name>" gitmap-v25/cmd/`
