...
1. Create a **Project** named `gitmap-v22`
...
| `SIGNPATH_PROJECT_SLUG` | Project settings | e.g., `gitmap-v22` |
...
```yaml
# Sign both gitmap-v22 and gitmap-updater Windows builds
WINDOWS_BINARIES=(
...
- **Sign all Windows binaries** — gitmap-v22 + gitmap-updater
