...
1. Create a **Project** named `gitmap-v24`
...
| `SIGNPATH_PROJECT_SLUG` | Project settings | e.g., `gitmap-v24` |
...
```yaml
# Sign both gitmap-v24 and gitmap-updater Windows builds
WINDOWS_BINARIES=(
...
- **Sign all Windows binaries** — gitmap-v24 + gitmap-updater
