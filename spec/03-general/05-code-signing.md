...
1. Create a **Project** named `gitmap-v25`
...
| `SIGNPATH_PROJECT_SLUG` | Project settings | e.g., `gitmap-v25` |
...
```yaml
# Sign both gitmap-v25 and gitmap-updater Windows builds
WINDOWS_BINARIES=(
...
- **Sign all Windows binaries** — gitmap-v25 + gitmap-updater
