...
`gitmap-v22` solves this in two blocking layers:

### Layer 1 — Parent → Handoff Worker

In `gitmap-v22/cmd/update.go`:
...
In `gitmap-v22/cmd/updatescript.go`:
...
- [../02-app-issues/03-update-sync-lock-loop.md](../02-app-issues/03-update-sync-lock-loop.md) — The real gitmap-v22 failure and its resolution
