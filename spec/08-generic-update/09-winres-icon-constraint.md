...
(`.github/workflows/release.yml`, line 54), which reads `gitmap-v22/winres/winres.json`
...
2. Updated `gitmap-v22/winres/winres.json` to reference `icon-256.png` instead.
...
| `gitmap-v22/assets/icon.png` | 512x512 original icon (web/docs use) |
