...
(`.github/workflows/release.yml`, line 54), which reads `gitmap-v25/winres/winres.json`
...
2. Updated `gitmap-v25/winres/winres.json` to reference `icon-256.png` instead.
...
| `gitmap-v25/assets/icon.png` | 512x512 original icon (web/docs use) |
