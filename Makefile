...
LDFLAGS  := -s -w \
  -X 'github.com/alimtvnetwork/gitmap-v24/gitmap/constants.Version=$(VERSION)' \
  -X 'github.com/alimtvnetwork/gitmap-v24/gitmap/cmd.BuildCommit=$(BUILD_COMMIT)' \
  -X 'github.com/alimtvnetwork/gitmap-v24/gitmap/cmd.BuildBranch=$(BUILD_BRANCH)' \
  -X 'github.com/alimtvnetwork/gitmap-v24/gitmap/cmd.BuildRepo=$(BUILD_REPO)' \
  -X 'github.com/alimtvnetwork/gitmap-v24/gitmap/cmd.BuildDate=$(BUILD_DATE)'
