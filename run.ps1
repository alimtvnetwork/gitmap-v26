...
function Build-Binary {
    ...
    try {
        ...
        $ldflags = "-X 'github.com/alimtvnetwork/gitmap-v25/gitmap/constants.RepoPath=$absRepoRoot'" +
                   " -X 'github.com/alimtvnetwork/gitmap-v25/gitmap/cmd.BuildCommit=$buildCommit'" +
                   " -X 'github.com/alimtvnetwork/gitmap-v25/gitmap/cmd.BuildBranch=$buildBranch'" +
                   " -X 'github.com/alimtvnetwork/gitmap-v25/gitmap/cmd.BuildRepo=$buildRepo'" +
                   " -X 'github.com/alimtvnetwork/gitmap-v25/gitmap/cmd.BuildDate=$buildDate'"
