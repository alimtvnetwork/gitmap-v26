...
const issues: Issue[] = [
  // ── paths ─────────────────────────────────────
  {
    ...
    fixCommand: `gitmap-v25 scan "C:\\Users\\you\\projects"\n# or just\ngitmap scan`,
    related: [
  ...
  },
  {
    ...
    fixCommand: `gitmap-v25 scan --out-file ./.gitmap/output/custom.json --output json`,
  },
  {
  ...
  // ── config ────────────────────────────────────
  {
    ...
    fixCommand: `gitmap-v25 scan --config "C:\\Users\\you\\.gitmap\\config.json"`,
  ...
  },
  {
    ...
    fixCommand: `gitmap-v25 setup --config ./data/git-setup.json`,
  ...
  },
  {
    ...
    fixCommand: `gitmap-v25 clone-next v++ --ssh-key work\n# or\nssh-add ~/.ssh/id_ed25519`,
  },
  {
    ...
    fixCommand: `gitmap-v25 scan ~/projects --mode https --output json\ngitmap clone json`,
  },
  {
  ...
  // ── locks ─────────────────────────────────────
  {
    ...
    cause: "Your shell is cwd'd into the target folder, so Windows holds a file lock and gitmap-v25 can't replace it.",
    fix: "Pass -f to force a chdir-to-parent + flatten, or 'cd ..' first.",
    fixCommand: `gitmap-v25 cn v+1 -f`,
  ...
  },
  {
    ...
    fixCommand: `gitmap-v25 cn v+1 --delete --verbose`,
  },
  {
    id: "stale-lockfile",
    category: "locks",
    title: "Stale gitmap-v25 lock file",
    symptom: "Doctor: Lock file exists — another gitmap-v25 may be running (or stale)",
    cause: "A previous gitmap-v25 process exited without releasing its advisory lock.",
    fix: "If no other gitmap-v25 is running, run doctor — it will surface the path; remove it manually only if needed.",
    fixCommand: `gitmap-v25 doctor`,
  },
  ...
  },
  {
    ...
    fixCommand: `gitmap-v25 scan ~/projects --output json\ngitmap clone json`,
  },
  ...
  // ── build ─────────────────────────────────────
  {
    id: "not-on-path",
    category: "build",
    title: "gitmap-v25 not found on PATH",
    symptom: "bash: gitmap-v25: command not found",
    ...
    fixCommand: `gitmap-v25 doctor --fix-path`,
  ...
  },
  {
    ...
    category: "build",
    title: "gitmap-v25 cd prints path but doesn't change directory",
    symptom: "Doctor: Shell wrapper not loaded — gitmap-v25 cd prints path but cannot change directory",
    cause: "The shell function wrapper that intercepts 'gitmap-v25 cd' has not been sourced.",
    fix: "Run setup, then reload your shell profile.",
    fixCommand: `gitmap-v25 setup\n# bash\nsource ~/.bashrc\n# zsh\nsource ~/.zshrc\n# PowerShell\n. $PROFILE`,
  },
];
  ...
  return (
    <DocsLayout>
      ...
      <p className="text-muted-foreground mb-6">
        Common gitmap-v25 errors grouped by category, each with the symptom, root cause, and the exact
        flag or command to fix it. When in doubt, start with{" "}
        <code className="docs-inline-code">gitmap-v25 doctor</code>.
      </p>
      ...
      <aside className="mt-10 rounded-lg border border-border bg-muted/20 p-5">
        ...
        <ul className="list-disc pl-5 space-y-1 text-sm text-muted-foreground">
          <li>
            Run <code className="docs-inline-code">gitmap-v25 doctor</code> for a full health snapshot.
          </li>
          <li>
...
const DiagnosticChecklist = () => {
  const steps: {
  ...
  }[] = [
    {
      ...
      command: "gitmap-v25 doctor",
    },
    {
      icon: Wrench,
      title: "Apply the auto-fixer if doctor flagged PATH",
      body: "If you see 'PATH binary version mismatch' or 'gitmap-v25 not found on PATH', let doctor sync the active binary from the deployed copy.",
      command: "gitmap-v25 doctor --fix-path",
    },
    {
      icon: Terminal,
      ...
      command: "gitmap-v25 <your-failing-command> --verbose",
    },
    {
      icon: FileText,
