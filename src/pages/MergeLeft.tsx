  ...
  <DocsLayout>
    <div className="max-w-4xl space-y-10">
      ...
      <section>
        ...
        <CodeBlock code={`gitmap-v25 merge-left LEFT RIGHT [flags]
gitmap-v25 ml         LEFT RIGHT [flags]`} />
      </section>
...
gitmap-v25 merge-left ./gitmap-v25 ./gitmap-v25

# Non-interactive (RIGHT wins by default for merge-left)
gitmap-v25 ml ./local https://github.com/owner/upstream -y

# Bypass + keep LEFT everywhere on conflict
gitmap-v25 merge-left ./mine ./theirs -y --prefer-left`} />
      </section>
