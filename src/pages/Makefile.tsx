...
const targets = [
  ...
  {
    name: "run",
    desc: "Build, deploy, and run gitmap-v22 with optional arguments.",
      ...
      <section className="space-y-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground mb-3">
            ...
            everything in <code className="font-mono text-primary">ARGS</code> to gitmap-v22 after building:
          </p>
          <CodeBlock
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            ...
            <code className="font-mono text-primary">gitmap-v22/Makefile</code> and invokes{" "}
