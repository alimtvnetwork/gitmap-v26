...
const HELP_COMMAND = `gitmap-v25 install --help
gitmap-v25 install --list
gitmap-v25 install node --dry-run
gitmap-v25 install node --manager choco --version 22.5.0`;

const HELP_BLOCKS = [
  [BadgeCheck, "Recommended path", "Use `gitmap-v25 install <tool>` first. It detects the platform, chooses the manager, verifies the binary, then records the install.", "recommended"],
