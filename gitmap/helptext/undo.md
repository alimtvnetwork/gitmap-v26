...
`undo` inside `gitmap-v24` never touches a `gitmap-v24` snapshot.
...
...
fix-repo: backed up 7 file(s) → .gitmap/backup/gitmap-v24/v20/fix-repo/20260519T134210Z

$ gitmap undo --list
undo: snapshots under .gitmap/backup/gitmap-v24/v20/fix-repo (2 total)
