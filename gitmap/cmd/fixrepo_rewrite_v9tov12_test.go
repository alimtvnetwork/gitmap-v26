...
import (
	...
	"github.com/alimtvnetwork/gitmap-v25/gitmap/fixtureversion"
)
...
// adjacent token (`gitmap-v25`) that MUST NOT match `gitmap-v25`.
...
//
// IMPORTANT: this body MUST contain `gitmap-v25` tokens (the rewrite
// target) and a `gitmap-v25` guarded neighbor. A previous global
...
// project's own module suffix (`gitmap`) collapses to `gitmap-v25` /
...
// `gitmap-v25` must survive untouched when bumping target=9, because
