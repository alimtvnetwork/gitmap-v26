...
func TestSlugFromRemote(t *testing.T) {
	cases := map[string]string{
		...
		"git@github.com:alimtvnetwork/gitmap-v25.git":     "gitmap-v25",
		"git@github.com:alimtvnetwork/gitmap-v25":         "gitmap-v25",
		"ssh://git@host.example/foo/bar/gitmap-v25.git":   "gitmap-v25",
		"gitmap-v25":     "gitmap-v25",
		"gitmap-v25.git": "gitmap-v25",
	}
...
// `current` value — historically this test pinned `gitmap-v25` next to
...
// `gitmap-v25` next to a `current=9` argument.
