...
func TestSlugFromRemote(t *testing.T) {
	cases := map[string]string{
		"https://github.com/alimtvnetwork/gitmap-v22.git": "gitmap-v22",
		"https://github.com/alimtvnetwork/gitmap-v22":     "gitmap-v22",
		"git@github.com:alimtvnetwork/gitmap-v22.git":     "gitmap-v22",
		"git@github.com:alimtvnetwork/gitmap-v22":         "gitmap-v22",
		"ssh://git@host.example/foo/bar/gitmap-v22.git":   "gitmap-v22",
		"gitmap-v22":     "gitmap-v22",
		"gitmap-v22.git": "gitmap-v22",
	}
...
// `current` value — historically this test pinned `gitmap-v22` next to
...
// `gitmap-v22` next to a `current=9` argument.
