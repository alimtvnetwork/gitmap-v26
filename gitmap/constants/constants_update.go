...
const (
	SourceRepoCloneURL   = "https://github.com/alimtvnetwork/gitmap-v24.git"
...
const (
	UpdateRemoteInstallerPwsh = "https://raw.githubusercontent.com/" +
		"alimtvnetwork/gitmap-v24/main/install.ps1"
	UpdateRemoteInstallerBash = "https://raw.githubusercontent.com/" +
		"alimtvnetwork/gitmap-v24/main/install.sh"
...
const (
	...
	UpdateCurrentRepoSlug  = "gitmap-v24"
...
`
	...
	//   %[1]s — repo path           (e.g. C:\dev\gitmap-v24)
